...
- [x] **Step 3: Implement the minimum CORS contract**
...
- [x] **Step 5: Document the browser-readable headers**
...
- [x] **Step 1: Write failing private-config tests**
...
- [x] **Step 3: Implement the pure config guard**
...
- [x] **Step 4: Run the guard tests to verify they pass**

Run: `npm test -- test/deploy-guards.test.js`

Expected: valid config passes and every unsafe config throws.

- [x] **Step 5: Write the failing sourceRevision smoke test**
...
- [x] **Step 6: Run the sourceRevision test to verify it fails**
...
- [x] **Step 7: Implement deploy-time SHA injection**
...
- [x] **Step 8: Implement smoke comparison and record field**
...
- [x] **Step 9: Run the focused sourceRevision and full tests**
...
- [x] **Step 10: Update operations and progress docs**
...
- [x] **Step 1: Write failing rollback dry-scenario tests**
...
- [x] **Step 2: Run the rollback tests to verify they fail**
...
- [x] **Step 3: Implement pure recovery helpers**
...
- [x] **Step 4: Run rollback tests to verify they pass**

Run: `npm test -- test/release-recovery.test.js`

Expected: all parser, command, success, and failure cases pass without any Cloudflare mutation.

- [x] **Step 5: Add active-version lookup to the release gate**
...
- [x] **Step 6: Add failure record and rollback path**
...
- [x] **Step 7: Verify the release gate control flow locally**
...
- [x] **Step 3: Implement deadline-aware attempt and wait calculations**
...
- [x] **Step 5: Regenerate and check browser artifact**
...
- [x] **Step 6: Document interactive/background usage**
...
- [x] **Step 1: Run static and generated checks**
...
- [x] **Step 3: Run both Worker dry-runs**
...
- [x] **Step 4: Execute production release gate**
...
- [x] **Step 5: Verify production evidence**
...
- [x] **Step 6: Update changelog and plan with final IDs**
...
- [x] **Step 7: Final verification and push**
