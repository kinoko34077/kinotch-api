...
test("ESM client artifact is generated from the canonical shared client", async () => {
  const source = await readFile("dist/text-transform.mjs", "utf8");
  assert.match(source, /^\/\/ Generated by scripts\/build-text-client\.mjs\. Do not edit manually\./);
  assert.match(source, /export const DEFAULT_TEXT_API_BASE_URL/);
  assert.match(source, /export function createTextTransformClient/);
});
