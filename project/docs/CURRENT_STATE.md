...
Last verified: 2026-09-24 — current-main release boundary and production provenance review
...
- Current repository revision is `088943a27f03bb5e3c3d21ec63b12326c61fa982`; implementation hardening is at `2da444092577ba335c802f901afaf08c2c0fe9f2`. GitHub Actions `CI` and `Verify` both succeeded for the current revision.
...
- The latest tracked production release metadata still records source revision `204d15eb382802aa776d5026421e197d52725300`; current `main` is `088943a27f03bb5e3c3d21ec63b12326c61fa982` and is not production-confirmed until an operator runs the formal release gate.
...
- `knt verify`
- `npm test`
- Local result at the current revision: 238 test cases, 237 passed, 0 failed, 1 skipped (opt-in live Gemini test)
